...
export const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const heroHeight = window.innerHeight * 0.95; // 95vh
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-md border-b border-border shadow-lg transition-all duration-300 ${
