    ...
    <section id="sobre" className="py-20 bg-secondary/30">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="font-nunito text-lg lg:text-xl text-muted-foreground leading-relaxed space-y-6">
            <p>
            ...
            <p className="text-foreground font-medium text-xl lg:text-2xl">
              Nossa missão é clara: <span className="font-script text-accent text-2xl lg:text-3xl">"formar através da leitura e da arte"</span>, 
